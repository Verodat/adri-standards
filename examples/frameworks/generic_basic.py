...
def sales_analyzer(sales_data):
    ...
    # Customer analysis
    unique_customers = sales_data['customer_id'].nunique() if 'customer_id' in sales_data.columns else 0
...
def user_profile_analyzer(user_data):
    ...
    if 'age' in user_data.columns:
        ...
        age_groups = pd.cut(user_data['age'], bins=[0, 25, 45, 65, 100], labels=['Young', 'Adult', 'Middle', 'Senior']).value_counts().to_dict()
    else:
        avg_age = 0
        age_groups = {}
...
def demonstrate_generic_protection():
    ...
    good_users = pd.DataFrame({
        ...
        'last_login': ['2024-01-15', '2024-01-14', '2024-01-13', '2024-01-16', '2024-01-12']
    })
