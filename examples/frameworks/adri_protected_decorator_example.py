...
import pandas as pd
from adri.decorators.guard import adri_protected, adri_strict, adri_permissive, adri_financial
...
def create_sample_data():
    ...
    bad_customers = pd.DataFrame({
        ...
        'email': ['alice@invalid', 'bob@example.com', 'not-an-email', 'diana@example.com', ''],
...
@adri_protected(
    ...
    standard_file="financial_transactions_v2.yaml"
)
...
def process_sensitive_data(sensitive_data):
    ...
    """
    print(f"Processing {len(sensitive_data)} sensitive records with strict protection...")
...
def process_financial_transactions(transaction_data):
    ...
    """
    print(f"Processing {len(transaction_data)} financial transactions with financial-grade protection...")
