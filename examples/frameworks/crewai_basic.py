...
def market_analysis_crew(market_data):
    ...
    risk_task = Task(
        description="Assess risks based on the market analysis",
        agent=risk_assessor
    )
    
    # Create and run the crew
    crew = Crew(
        agents=[market_analyst, risk_assessor],
...
def customer_support_crew(customer_data):
    ...
    escalation_task = Task(
        description="Handle any escalated issues",
    ...
    crew = Crew(
        ...
        tasks=[triage_task, escalation_task]
    )
